...
$("#draggable").draggable({
    scroll: false, // Evitar interferencias con el scroll nativo
    containment: "body", // Limitar el arrastre al cuerpo de la página
    start: function () {
        // Pausar Locomotive Scroll al iniciar el arrastre
        scroll.stop();
    },
    stop: function () {
        // Reanudar Locomotive Scroll al soltar la linterna
        scroll.start();
    }
});
